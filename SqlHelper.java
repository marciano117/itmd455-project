package com.example.jj.finalproject;
...
// 4. Close dbase
    ...
    public void userTable(User user) {      //this class will create a table for each new user
        ...
        String CREATE_INDIVIDUAL_TABLE = "CREATE TABLE " + KEY_USER + "( " +
                KEY_UID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + KEY_USER + " TEXT, " +
                "Punch In DATE, Punch Out DATE);";
...
/*CRUD operations (create "add", read "get", update, delete) */
    public void punchIn(User user, Times time){    //I don't know what object we'll use, so I passed time
...
// 2. create ContentValues to add key "column"/value
        ...
        values.put("Punch Out", null);  //this method is only for punch in so nothing will be in punch out
// 3. insert
